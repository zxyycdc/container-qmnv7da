...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qmnv7da.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qmnv7da.containers.anotherwebservice.com/
...
```
git clone git@github.com:zxyycdc/container-qmnv7da.git
cd container-qmnv7da
```
...
```
docker attach container-qmnv7da
```
